...
class getSecurityControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.Np2gF_h'] ?? $container->load('get_ServiceLocator_Np2gFHService'))->withContext('App\\Controller\\SecurityController', $container));
