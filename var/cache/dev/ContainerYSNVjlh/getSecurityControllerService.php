...
class getSecurityControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.LIBYGwH'] ?? $container->load('get_ServiceLocator_LIBYGwHService'))->withContext('App\\Controller\\SecurityController', $container));
